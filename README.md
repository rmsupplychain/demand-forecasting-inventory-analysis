...
Files
[Full Excel File](Demand_Forecast_Analysis_Project_FINAL.xlsx)-full working file with raw data, item-level forecasts, safety stock/reorder point calculations, and the dashboard
![Dashboard](Demand Forecasting & Inventory Analysis Dashboard Screenshot.png)
